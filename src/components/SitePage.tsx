...
import type { HeroVariant } from "@/lib/hero-diagnosis";

/* גוף העמוד המלא, משותף לכל הראוטים. ההבדל היחיד בין / לבין /marketing
   הוא גרסת ההירו — כל השאר (שירותים, תוצאות, עליי, טופס) זהה, ולכן הוא
   חי כאן פעם אחת ולא משוכפל בין שני קבצי page. */
export default function SitePage({ hero = "site" }: { hero?: HeroVariant }) {
  return (
    <>
      <Header />
      <main id="main">
        {/* ================= HERO — מערכת אבחון (Digital Twin) ================= */}
        <HeroExperience variant={hero} />
